        ...
        session_start(); 
			...
			<ul class="navbar-nav text-uppercase ml-auto">
			  <ul class="nav navbar-nav">
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="Car">Car <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li>
										<a href="Car.php">View Cars</a>
									</li>
									<li>
										<a href="Car.php?action=insert>Add Car</a>
									</li>
									<li>
										<a href="Car.php?action=edit">edit Car</a>
									</li>
								</ul>
						</li>
