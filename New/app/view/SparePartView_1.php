				...
				<div class="col-lg-8 mx-auto">
				  <div class="modal-body">
					...
					foreach ($this->model->getSpareParts() as $SparePart) {
						...
						<form method="post" action="exportIndex.php">

					<h2 class="text-uppercase" name="CarID">'.$SparePart->getcarName() .'</h2>
					<input class="hidden" name="hidden_CarID" value="'.$SparePart->getcarID().'" hidden/>
					...
					<div class="col-md-4">
						...
						$str.='<div class="btn-group col-md-1" >
