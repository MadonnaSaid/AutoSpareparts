			  ...
			  $str.="<section class='bg-light page-section' id='portfolio'>
			   ...
			   <div class='row'>
				 ...
				 foreach ($this->model->getCars() as $Car) {
					 ...
					 <a type ='submit' class='portfolio-link' data-toggle='modal' onclick=\"location.href='SparePart.php?CarID=".$Car->getCarID()."'\" >
...
<form action="Car.php?action=addAction" method="post">
	...
	<h2>Add Car</h2>
		...
		<div class="form-group">
			<div>
			<input type="text" class="form-control" name="CarYear" id="CarYear" placeholder="Enter Year"/>
			</div>
			</div>
		<br>
		<div class="form-group">
