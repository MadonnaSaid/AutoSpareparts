		...
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav text-uppercase ml-auto">
			  ...
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#portfolio"> Export/Import </a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#about">Check Out</a>
			  </li>
			   <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#team">History module</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#contact">Add Company</a>
			  </li>
			</ul>
		  </div>
		</div>
