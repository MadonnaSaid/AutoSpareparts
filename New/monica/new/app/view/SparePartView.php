...
{	
	public function output()
    {
		...
		<style type="text/css">';
	$str='	<div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
				...
				<div class="col-lg-8 mx-auto">
				  <div class="modal-body">
					...
					foreach ($this->model->getSpareParts() as $SparePart) {
                        $str.='
					<h2 class="text-uppercase" name="hidden_CarName">'.$SparePart->getcarName() .'</h2>
					...
					<div class="col-md-4">
						...
						<input type="hidden" name="hidden_PartNumber"  valule="'.$SparePart->getPartNumber() .'">
							...
							<input type="text" style= "margin-left: 222px" name="quantity" value="1" class="form-group col-md-7" /><br>
						...
						<li class="list-group-item">PartName: '.$SparePart->getPartName() .'</li>
						<li class="list-group-item">PartNumber: '.$SparePart->getPartNumber() .'</li>
						<li class="list-group-item">PartPrice:'.$SparePart->getpartPrice() .'</li>
						<li class="list-group-item">Country: '.$SparePart->getpartCountry() .'</li>
						<li class="list-group-item">PartQuantity:'.$SparePart->getpartQuantity() .'</li>
						</ul>					
						<br> 
						
							<div class="btn-group col-md-1" >
							<form method="post" action="Addcompany.php">
							<input type="submit" name="Export" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" value="Export"/>
							</form>
							</div>
							<div class="btn-group col-md-1" >
							<form method="post" action="spareParts.php?action=Import">
							<input type="submit" style= "margin-left: 50px" name="Import" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" value="Import"/>
									  </div>
									  <br><br>  
