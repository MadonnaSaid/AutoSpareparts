...
class Company extends Model
{
	...
	function Model_editCompany($LocalCompanyID,$CompanyName, $email,$phoneNumber,$RegisterSupplierNumber,$CommercialRecord)
	{
		$sql = "UPDATE comany set name='$CompanyName',email='$email', phoneNumber='$phoneNumber' ,RegisterSupplierNumber='$RegisterSupplierNumber', CommercialRecord='$CommercialRecord' where LocalCompanyID=$this->LocalCompanyID;";
	...
	function deleteCompany(){
		$sql="delete from localcompany where id=$this->LocalCompanyID;";
		if($this->db->query($sql) === true){
